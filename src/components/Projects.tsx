    ...
    <section id="projects" className="py-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Active Collaborations</h2>
            <p className="text-lg text-foreground/70 max-w-2xl">
              Join existing projects or propose new initiatives to address pressing global challenges.
            </p>
          </div>
          <Button className="mt-4 md:mt-0">View All Projects</Button>
        </div>
